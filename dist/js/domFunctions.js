...
export const updateDisplay = (weatherJson,loactionObj) =>{
    fadeDisplay();
    clearDisplay();
...
const setBGImage =(weatherClass) =>{
    ...
    document.documentElement.classList.forEach(img =>{
        if(img !== weatherClass) document.documentElement.classList.remove(image);
    });
}


const buildScreenReaderWeather = (weatherJson,loactionObj) =>{
    const location = loactionObj.getName();
    const unit = loactionObj.getUnit();
